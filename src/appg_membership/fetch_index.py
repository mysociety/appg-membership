...
def parse_appg_html(html: str, *, slug: str, source_url: str) -> APPG:
    """
...
def get_appg_data(url: str) -> APPG:
    """
    ...
    return parse_appg_html(response.text, slug=slug, source_url=url)


def fetch_from_index(index_date: str = "250328"):
